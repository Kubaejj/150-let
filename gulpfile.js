...
//npm install --save-dev gulp gulp-cli gulp-nunjucks-render gulp-data gulp-plumber fancy-log ansi-colors gulp-htmllint gulp-prettyerror gulp-sass sass gulp-postcss autoprefixer cssnano gulp-terser gulp-avif
...
// (onepage) pages task removed — only `renderIndex` is used
...
function watchFiles() {
    ...
    watch(paths.dataFile, series(renderIndex));
